...
-(void)  openSatellites
{
    ...
    if(popAperto == 0)
    {
        ...
        UIActionSheet*  actionSheet =[[UIActionSheet alloc] initWithTitle:@"Seleziona Satellite" delegate:self cancelButtonTitle:@"Seleziona" destructiveButtonTitle:@"Annulla" otherButtonTitles: nil ];
