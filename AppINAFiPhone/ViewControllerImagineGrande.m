...
//  INAF1
// Special thanks to the guide (http://www.raywenderlich.com/10518/how-to-use-uiscrollview-to-scroll-and-zoom-content)
...
@interface ViewControllerImagineGrande ()
{
    NSURLConnection * connection ;
}
@end

@implementation ViewControllerImagineGrande
