...
- (void)mapView:(MKMapView *)mapView didSelectAnnotationView:(MKAnnotationView *)view {
    ...
    if([device.systemVersion hasPrefix:@"7"] || [device.systemVersion hasPrefix:@"8"] || [device.systemVersion hasPrefix:@"9"] )
    {
        ...
        if(![view.annotation isKindOfClass:[MKUserLocation class]]) {
            ...
            calloutView = [[UIView alloc] initWithFrame:CGRectMake((self.view.frame.size.width-280)/2,(self.view.frame.size.height -200)/2-(200/2), 280, 200)];
            ...
            [phone setText:[NSString stringWithFormat:@"Telefono: %@",i.phone]];
